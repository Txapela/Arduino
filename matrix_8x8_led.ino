...
const int data[] PROGMEM = {
  ...
  0x00, 0x00, 0x3F, 0x41, 0x49, 0x4F, 0x00, 0x00, // "G"
  ...
  0x00, 0x00, 0x7F, 0x30, 0x0C, 0x30, 0x7F, 0x00, // "M"
  0x00, 0x00, 0x7F, 0x30, 0x0C, 0x03, 0x7F, 0x00, // "N"
  ...
  0x00, 0x7E, 0x01, 0x02, 0x04, 0x02, 0x01, 0x7E, // "W"
  0x00, 0x00, 0x63, 0x14, 0x08, 0x14, 0x63, 0x00, // "X"
  0x00, 0x00, 0x60, 0x10, 0x0F, 0x10, 0x60, 0x00, // "Y"
...
void loop() {
  ...
  for (int i = 0; i < 290; i++) { // "space，0-9，A-F"16 letters ,each letter hold 8 columns, total 136 columns. Firstly, display space ,then we need shift 128 times（136-8）
